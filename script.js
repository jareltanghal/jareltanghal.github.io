...
const PROJECTS = [
  ...
  },
  {
    ...
    ongoing: false,
    contribution:
      "Full Stack — Solo Project. Built and presented the payroll sync workflow for Phoenix Water Solutions, covering authentication, account approvals, ServiceTitan/Time Doctor timesheet review, user controls, API setup, and Paylocity export states.",
    image: "project-previews/timesheet-payroll/08-dashboard.png",
    demoUrl: "phoenix-payroll-sync.local",
    previews: [
      ...
      "project-previews/timesheet-payroll/19-profile-security-active-session.png",
